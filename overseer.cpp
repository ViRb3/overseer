...
namespace Overseer
{
    vector<string> BlacklistedDirs = {"/acct", "/cache", "/data/app", "/data/data", "/data/media", "/dev", "/mnt",
                                      "/proc", "/storage", "/sys/power", "/sys/kernel"};
    vector<string> BlacklistedFiles = { };
    vector<string> BlacklistedExts = {".zip", ".gzip", ".tar", ".rar", ".mp3", ".ogg", ".wav", ".mp4", ".mov", ".jpg",
                                             ".jpeg", ".bmp", ".png", ".apk"};
    ...
    vector<size_t> FindInFile(const string &needle, FILE *pFile)
    {
        ...
        char *buffer2 = (char *) malloc(sizeof(char) * needleLength * 2); //TODO: Free
